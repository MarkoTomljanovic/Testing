package hr.marko.springbootunittesting.test;

import hr.marko.springbootunittesting.MvcTestingExampleApplication;
import hr.marko.springbootunittesting.models.CollegeStudent;
import hr.marko.springbootunittesting.models.StudentGrades;
...
class ApplicationExampleTest {
    ...
    public void beforeEach() {
        ...
        student.setFirstname("Pero");
        student.setLastname("Peric");
        student.setEmailAddress("pero@peric.com");
    ...
    public void createStudentWithoutGradesInit() {
        ...
        studentTwo.setFirstname("Mirko");
        studentTwo.setLastname("Mirkic");
        studentTwo.setEmailAddress("mirko@mirkic.com");
